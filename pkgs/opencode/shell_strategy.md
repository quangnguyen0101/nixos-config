<!-- Vendored from https://github.com/JRedeker/opencode-shell-strategy (trunk/shell_strategy.md, MIT).
     Loaded via instructions[] in opencode.json. Sync manually when upstream changes. -->
